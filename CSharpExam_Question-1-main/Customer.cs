...
namespace CSharpExam
{
    ...
    class CustomerManagerDemo
    {
        ...
        {
            Customer c1 = new Customer(1, "Abhay", "Mysore", 55000);
            Customer c2 = new Customer(2, "Rahul", "Patna", 45000);
            Customer c3 = new Customer(3, "Rohan", "Delhi", 60000);
